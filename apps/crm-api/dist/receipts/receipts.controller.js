...
let ReceiptsController = class ReceiptsController {
    ...
    async receive(dto) {
        return this.receiptsService.processReceipt(dto.messageId, dto.status, new Date(dto.timestamp), dto.metadata);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [ReceiptDto]),
    __metadata("design:returntype", Promise)
], ReceiptsController.prototype, "receive", null);
